...
def append_purchase_log(file_path, sysbol,purchase_time, purchase_price, sell_price):
    with open(file_path, 'a') as f:
        log_line = f"{purchase_time}, 币种: {sysbol}, 购买价格: {purchase_price}, 卖出价格: {sell_price}\n"
        f.write(log_line)
